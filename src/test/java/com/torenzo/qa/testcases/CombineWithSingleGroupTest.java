...
import junit.framework.Assert;
 ...
 public class CombineWithSingleGroupTest extends Loginapp{
		TouchAction action;
		Reusemethod call = new Reusemethod();
		public CombineWithSingleGroupTest() throws IOException{
			super();
		}
		...
		@Test(priority=3)		
			...
			for(int t=1; t<20; t++){
					...
					WebElement	ele1 = driver.findElement(By.id("com.torenzo.torenzocafe:id/guest_layout"));
			...
			List<WebElement> guestCountFromGroup = driver.findElements(By.id("guest_name"));
			System.out.println("guestCountFromGroup = " +guestCountFromGroup.size());
